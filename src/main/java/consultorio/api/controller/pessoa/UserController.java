...
public class UserController {
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN') or @securityService.isOwnUser(#id, #userDetails)")
    ...
    @PreAuthorize("hasRole('ADMIN') or #username == #userDetails.username")
    @Operation(summary = "Buscar usuário por username")
    public ResponseEntity<UserResponse> buscarPorUsername(
    ...
    public ResponseEntity<UserResponse> me(@AuthenticationPrincipal UserDetails userDetails) {
        return ResponseEntity.ok(service.buscarPorUsername(userDetails.getUsername()));
    }
